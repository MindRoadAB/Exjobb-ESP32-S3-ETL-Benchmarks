...
string_operations(void)
{
    ...
    CYCLE_GET_COUNT(std::reverse(str.begin(), str.end()), cycle_count, "reverse"); 
    ...
    _string s = {
                ...
                }, cycle_count, "constructor-long string"); 
    ...
    _string s1 = {
                    ...
                    "Hello my name is warren and I am 39 and I live in Sweden.\n"
                    "Hej Jag heter warren och jag är 39 och bor i Sverige."
                }, cycle_count, "constructor- very long string"); 
    ...
    CYCLE_GET_COUNT(_string s2 = {"hi"}, cycle_count, "constructor- short string");
    CYCLE_GET_COUNT(std::reverse(s1.begin(), s1.end()), cycle_count, "reverse very long string");
    ...
    CYCLE_GET_COUNT(std::reverse_copy(std::begin(str), std::end(str), std::begin(str2)), cycle_count, "reverse_copy");
