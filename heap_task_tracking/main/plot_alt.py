...
ax.grid(True)
fig.tight_layout()
fig.savefig(RESULTS_DIR / 'heap_ratio_all_configs-vector-30min-noresize.png')
plt.close(fig)
...
ax.grid(True)
fig.tight_layout()
fig.savefig(RESULTS_DIR / 'free_heap_all_configs-vector-30min-noresize.png')
plt.close(fig)
...
ax.grid(True)
fig.tight_layout()
fig.savefig(RESULTS_DIR / 'largest_block_all_configs-vector-30min-noresize.png')
plt.close(fig)
...
ax.grid(True)
fig.tight_layout()
fig.savefig(RESULTS_DIR / 'fragmentation_all_configs-vector-30min-noresize.png')
plt.close(fig)
